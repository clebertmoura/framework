(function () {
  'use strict';
    ...
    CidadeController.$inject = ['$controller', '$routeParams', '$rootScope', '$scope', '$filter', '$location', 'FlashFactory',  'CidadeFactory', 'CidadeService', 'UfFactory', 'UfService'];


  /**
   * Controlador do Processo que estende as funcionalidades do BaseController. 
   */
  function CidadeController($controller, $routeParams, $rootScope, $scope, $filter, $location, FlashFactory, 
    ...
    $controller('BaseController', { vm: vm, factory: CidadeFactory, restrictions: getRestrictions(), entityName: 'Cidade', entity: vm.cidade });
