...
public abstract class BaseEntityAuditedImpl<PK extends Serializable> extends BaseEntityImpl<PK>
	 ...
	 * (non-Javadoc)
	 * 
	 * @see br.com.framework.domain.api.BaseEntityAudited${symbol_pound}getStatus()
	 */
	@Override
	 ...
	 * (non-Javadoc)
	 * 
	 * @see br.com.framework.domain.api.BaseEntityAudited${symbol_pound}setStatus(br.com.
	...
	/* (non-Javadoc)
	 * @see br.com.framework.domain.api.BaseEntityAudited${symbol_pound}setLastModifiedDate(java.util.Date)
	 */
	@Override
	 ...
	 * 
	 * @see
	 * br.com.framework.domain.api.BaseEntityAudited${symbol_pound}getDataModificacao()
	 */
	@Override
	 ...
	 * (non-Javadoc)
	 * 
	 * @see br.com.framework.domain.api.BaseEntityAudited${symbol_pound}getUsuarioLogin()
	 */
	...
	/* (non-Javadoc)
	 * @see br.com.framework.domain.api.BaseEntityAudited${symbol_pound}setUserLogin(java.lang.String)
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see br.com.framework.domain.api.BaseEntityAudited${symbol_pound}isAtivo()
	 */
	@Override
	@Transient
