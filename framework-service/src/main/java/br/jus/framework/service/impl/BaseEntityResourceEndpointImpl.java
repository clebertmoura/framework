...
import br.jus.framework.model.dao.api.BaseDao;
...
import br.jus.framework.search.impl.PageResponse;
import br.jus.framework.search.util.SearchUtil;
import br.jus.framework.service.api.BaseEntityResource;
import br.jus.framework.service.api.BaseEntityResourceEndpoint;
import br.jus.framework.service.api.BaseResource;
import br.jus.framework.service.api.Error;
import br.jus.framework.service.api.PaginatedResourceResponse;
import br.jus.framework.service.util.LoadRelatedEntityResource;
...
public abstract class BaseEntityResourceEndpointImpl<PK extends Serializable, E extends BaseEntity<PK>, R extends BaseEntityResource<PK, E>, B extends Search<PK, E>, Manager extends BaseManager<PK, E, B>>
	...
	/* (non-Javadoc)
	 * @see br.jus.framework.service.api.BaseResourceEndpoint#getCountTodos()
	 */
	@Override
	@GET
    @Path("/count")
