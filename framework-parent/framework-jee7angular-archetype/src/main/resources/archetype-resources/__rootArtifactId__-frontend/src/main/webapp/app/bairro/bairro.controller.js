(function () {
  'use strict';
    ...
    BairroController.$inject = ['$controller', '$routeParams', '$rootScope', '$scope', '$filter', '$location', 'FlashFactory',  'BairroFactory', 'BairroService', 'CidadeFactory', 'CidadeService'];


  /**
   * Controlador do Processo que estende as funcionalidades do BaseController. 
   */
  function BairroController($controller, $routeParams, $rootScope, $scope, $filter, $location, FlashFactory, 
    ...
    $controller('BaseController', { vm: vm, factory: BairroFactory, restrictions: getRestrictions(), entityName: 'Bairro', entity: vm.bairro });
