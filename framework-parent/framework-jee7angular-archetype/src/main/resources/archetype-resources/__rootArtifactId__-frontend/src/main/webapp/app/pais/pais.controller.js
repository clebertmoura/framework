(function () {
  'use strict';
    ...
    PaisController.$inject = ['$controller', '$routeParams', '$rootScope', '$scope', '$filter', '$location', 'FlashFactory',  'PaisFactory', 'PaisService', 'ImagemFactory', 'ImagemService'];


  /**
   * Controlador do Processo que estende as funcionalidades do BaseController. 
   */
  function PaisController($controller, $routeParams, $rootScope, $scope, $filter, $location, FlashFactory, 
    ...
    $controller('BaseController', { vm: vm, factory: PaisFactory, restrictions: getRestrictions(), entityName: 'Pais', entity: vm.pais });
