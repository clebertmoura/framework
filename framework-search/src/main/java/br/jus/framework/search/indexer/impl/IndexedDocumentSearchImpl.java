...
import br.jus.framework.search.impl.SearchImpl;
import br.jus.framework.search.indexer.api.IndexedDocument;
import br.jus.framework.search.indexer.api.IndexedDocumentSearch;
import br.jus.framework.search.indexer.api.service.IndexerService;
import br.jus.framework.search.util.SearchUtil;
import br.jus.framework.util.reflection.ReflectionUtils;
...
public abstract class IndexedDocumentSearchImpl<DocId extends Serializable, Doc extends IndexedDocument<DocId>>
	...
	/* (non-Javadoc)
	 * @see br.jus.framework.search.search.indexer.api.IndexedDocumentSearchable#findByUUID(java.lang.String)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see br.jus.framework.search.search.api.Searchable#getRecordCountFindByRestrictions(java.util.List)
	 */
	@Override
