 ...
 *
 */
public class EntityDetailIncGenerator extends BaseResourceGenerator{
	
	public static final String TEMPLATE = "frontend/entity/detail-inc.html.ftl";
	public static final String PATH = "app";
	public static final String SUFIX = "detail-inc";
	 ...
	 */
	public EntityDetailIncGenerator(GeneratorProcessor generatorProcessor, EntityMetamodel entityMetamodel) {
