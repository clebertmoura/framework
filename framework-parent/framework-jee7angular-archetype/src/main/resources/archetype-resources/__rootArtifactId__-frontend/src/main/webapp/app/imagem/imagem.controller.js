(function () {
  'use strict';
    ...
    ImagemController.$inject = ['$controller', '$routeParams', '$rootScope', '$scope', '$filter', '$location', 'FlashFactory',  'ImagemFactory', 'ImagemService'];


  /**
   * Controlador do Processo que estende as funcionalidades do BaseController. 
   */
  function ImagemController($controller, $routeParams, $rootScope, $scope, $filter, $location, FlashFactory, 
    ...
    $controller('BaseController', { vm: vm, factory: ImagemFactory, restrictions: getRestrictions(), entityName: 'Imagem', entity: vm.imagem });
