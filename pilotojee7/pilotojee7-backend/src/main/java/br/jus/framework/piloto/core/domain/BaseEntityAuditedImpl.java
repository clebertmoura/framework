...
public abstract class BaseEntityAuditedImpl<PK extends Serializable> extends BaseEntityImpl<PK>
	 ...
	 * (non-Javadoc)
	 * 
	 * @see br.jus.framework.domain.api.BaseEntityAudited#getStatus()
	 */
	@Override
	 ...
	 * (non-Javadoc)
	 * 
	 * @see br.jus.framework.domain.api.BaseEntityAudited#setStatus(br.com.
	...
	/* (non-Javadoc)
	 * @see br.jus.framework.domain.api.BaseEntityAudited#setLastModificationDate(java.time.LocalDateTime)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see br.jus.framework.domain.api.BaseEntityAudited#getLastModificationDate()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see br.jus.framework.domain.api.BaseEntityAudited#getLastModificationAuthor()
	 */
	...
	/* (non-Javadoc)
	 * @see br.jus.framework.domain.api.BaseEntityAudited#setCreationAuthor(java.lang.String)
	 */
	...
	/* (non-Javadoc)
	 * @see br.jus.framework.domain.api.BaseEntityAudited#setLastModificationAuthor(java.lang.String)
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see br.jus.framework.domain.api.BaseEntityAudited#isAtivo()
	 */
	@Override
	@Transient
