package br.jus.framework.search.indexer.listener;
...
import br.jus.framework.search.indexer.annotations.DocumentId;
import br.jus.framework.search.indexer.annotations.Indexed;
	...
	private void initIndexFieldsList(Class<?> entityClass, List<Field> fieldsToIndex, List<Field> fieldsDocumentId) {
		...
		for (Field field : allFields) {
			if (!Modifier.isStatic(field.getModifiers())) {
				if (field.isAnnotationPresent(br.jus.framework.search.indexer.annotations.Field.class)) {
					...
					if (method != null) {
						if (method.isAnnotationPresent(br.jus.framework.search.indexer.annotations.Field.class)) {
							fieldsToIndex.add(field);
