package br.jus.framework.util.security;
...
import br.jus.framework.util.exception.InvalidKeystorePassword;
import br.jus.framework.util.exception.InvalidPrivateKeyPassword;
