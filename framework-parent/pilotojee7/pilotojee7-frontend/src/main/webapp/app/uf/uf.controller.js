(function () {
  'use strict';
    ...
    UfController.$inject = ['$controller', '$routeParams', '$rootScope', '$scope', '$filter', '$location', '$uibModal', 'FlashFactory',  'UfFactory', 'UfService', 'PaisFactory', 'PaisService'];


  /**
   * Controlador da entidade Uf que estende as funcionalidades do BaseController. 
   */
  function UfController($controller, $routeParams, $rootScope, $scope, $filter, $location, $uibModal, FlashFactory, 
    ...
    $controller('BaseController', { vm: vm, factory: UfFactory, entityName: 'Uf', entity: vm.uf, $scope: $scope });
