...
import { EntityListComponent } from '../../../../../../framework-tjpe-lib/src/lib/framework/components/entity-list.component';
import { MessageService } from '../../../../../../framework-tjpe-lib/src/lib/framework/util/message.service';
import { FilterMetadata } from 'projects/framework-tjpe-lib/src/lib/framework/service/paging/filtermetadata';
import { Operator } from '../../../../../../framework-tjpe-lib/src/lib/framework/service/paging/operator';
