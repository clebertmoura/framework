...
import br.jus.framework.domain.util.BaseEntityHashBuilder;
...
public abstract class BaseEntityImpl<PK extends Serializable> implements BaseEntity<PK> {
	...
	/* (non-Javadoc)
	 * @see br.jus.framework.domain.api.BaseEntity#getVersaoEntidade()
	 */
	@Override
	@Version
	...
	/* (non-Javadoc)
	 * @see br.jus.framework.domain.api.BaseEntity#setVersaoEntidade(java.lang.Long)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see br.jus.framework.domain.api.BaseEntity#version(java.lang.Long)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see br.jus.framework.domain.api.BaseEntity#entityClassName()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see br.jus.framework.domain.api.BaseEntity#isIdSet()
	 */
	@Override
	@Transient
