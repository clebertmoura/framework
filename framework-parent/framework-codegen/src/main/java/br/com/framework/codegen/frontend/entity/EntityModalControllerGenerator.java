 ...
 *
 */
public class EntityModalControllerGenerator extends BaseResourceGenerator{
	
	public static final String TEMPLATE = "frontend/entity/entity-modal.controller.js.ftl";
	public static final String PATH = "app";
	public static final String SUFIX = "-modal.controller";
	 ...
	 */
	public EntityModalControllerGenerator(GeneratorProcessor generatorProcessor, EntityMetamodel entityMetamodel) {
