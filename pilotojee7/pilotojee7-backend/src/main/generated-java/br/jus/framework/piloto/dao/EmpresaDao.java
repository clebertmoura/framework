...
/**
 * Implementação de DAO da entidade: {@link Empresa} 
 *
 * @see AppBaseDaoImpl
 */
@Stateless
public class EmpresaDao extends AppBaseDaoImpl<Long, Empresa> {
    ...
    @Override
    protected void addGlobalFilterPredicates(PageRequest pageRequest, List<Predicate> predicates, CriteriaBuilder cBuilder, Root<Empresa> from,
