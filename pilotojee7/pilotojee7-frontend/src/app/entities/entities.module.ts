...
@NgModule({
  ...
  declarations: [
    ...
    ProfissionalSaudeListComponent,
    ProfissionalSaudeDetailComponent,
    ProfissionalSaudeLineComponent,
    ProfissionalSaudeAutocompleteComponent,
    QualificacaoProfissionalListComponent,
    QualificacaoProfissionalDetailComponent,
    QualificacaoProfissionalLineComponent,
    QualificacaoProfissionalAutocompleteComponent,
    StatusListComponent,
    StatusDetailComponent,
    StatusLineComponent,
    StatusAutocompleteComponent,
    TipoAgendaListComponent,
    TipoAgendaDetailComponent,
    TipoAgendaLineComponent,
    TipoAgendaAutocompleteComponent,
    TipoConsultaListComponent,
